...
//  public static int[] buildIncreasingArray( int size, int startValue, int step )
  ...
  */
  ...
  public static void main( String[] args )
  {
    ...
    System.out.println(firstOccurence(data, 15));
    //prints out the first occurrence of 15 in the random array named data. If there is no 15, it prints out the length of the array named data.
  }
}